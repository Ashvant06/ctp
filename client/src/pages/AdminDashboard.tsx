...
function Courses({ navigate }: { navigate: (path: string) => void }) {
  return (
    <div style={styles.section}>
      ...
      <div style={styles.emptyState}>
        Click "Manage Courses" to view and manage your courses.
      </div>
    </div>
  );
}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  secondaryBtn: { padding: "9px 18px", background: "#ffffff", color: "#111827", border: "1px solid #d1d5db", borderRadius: "8px", fontSize: "14px", fontWeight: 600, cursor: "pointer" },
